...
`)},de=(t,o=!0)=>a=>(o&&re(t),a.env.isDebug&&l.info("Options:",t),x(a,{id:"hope"}),{name:h,define:ce(t),extendsBundlerOptions:(e,n)=>{t.components?.includes("ArtPlayer")&&A(e,n,"artplayer"),t.components?.includes("VidStack")&&T(e,n,/^media-/),z(e,n,["@vuepress/helper","vuepress-shared"])},clientConfigFile:e=>ue(e,t)});export{k as AVAILABLE_SERVICES,r as SHARE_CONFIG,de as componentsPlugin,g as pdfLocaleInfo,P as siteInfoLocaleInfo,y as vidstackLocaleInfo};
