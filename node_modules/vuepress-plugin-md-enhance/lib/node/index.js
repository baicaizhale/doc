import{encodeData as k,entries as v,Logger as he,ensureEndingSlash as ke,isModuleAvailable as be,isDef as $e,isPlainObject as C,keys as M,endsWith as x,deepAssign as T,fromEntries as I,getModulePath as ve,isArray as Pe,addViteSsrNoExternal as we,addViteOptimizeDepsExclude as O,addViteSsrExternal as P,addViteOptimizeDepsInclude as D,addViteOptimizeDepsNeedsInterop as Ce,chainWebpack as je}from"@vuepress/helper";import{useSassPalettePlugin as Se}from"@vuepress/plugin-sass-palette";import{hash as Me,path as xe,getDirname as _e,colors as w,logger as Ie}from"vuepress/utils";import{createConverter as Oe}from"vuepress-shared/node";import{container as _}from"@mdit/plugin-container";import{demo as De}from"@mdit/plugin-demo";import{uml as Re}from"@mdit/plugin-uml";import{plantuml as Ee}from"@mdit/plugin-plantuml";const z=e=>{_(e,{name:"chartjs",openRender:(t,n)=>{const a=t[n].info.trimStart().slice(7).trim(),s=`chartjs-${n}`;let o="{}",r="";for(let l=n;l<t.length;l++){const{type:i,content:f,info:u}=t[l];if(i==="container_chartjs_close")break;f&&(i==="fence"&&(u==="json"?(o=k(f),r="json"):(u==="js"||u==="javascript")&&(o=k(f),r="js")),t[l].type="chartjs_empty",t[l].hidden=!0)}return`<ChartJS id="${s}" config="${o}" ${a?`title="${encodeURIComponent(a)}" `:""}type="${r}">`},closeRender:()=>"</ChartJS>"})},R=e=>e.replace(/&/gu,"&amp;").replace(/</gu,"&lt;").replace(/>/gu,"&gt;").replace(/"/gu,"&quot;").replace(/'/gu,"&#39;"),F={useBabel:!1,jsLib:[],cssLib:[],codepenLayout:"left",codepenEditors:"101",babel:"https://unpkg.com/@babel/standalone/babel.min.js",vue:"https://unpkg.com/vue/dist/vue.global.prod.js",react:"https://unpkg.com/react/umd/react.production.min.js",reactDOM:"https://unpkg.com/react-dom/umd/react-dom.production.min.js"},E=e=>t=>{_(t,{name:e,openRender:(n,a)=>{const s=n[a].info.trimStart().slice(e.length).trim();let o="";const r={};for(let l=a;l<n.length;l++){const{type:i,content:f,info:u}=n[l],m=u?/^([^ :[{]+)/.exec(t.utils.unescapeAll(u).trim())?.[1]??"text":"";if(i===`container_${e}_close`)break;f&&i==="fence"&&(m==="json"?o=k(f):r[m]=f)}return`<CodeDemo id="code-demo-${a}" type="${e.split("-")[0]}"${s?` title="${encodeURIComponent(s)}"`:""}${o?` config="${o}"`:""} code="${k(JSON.stringify(r))}">
...
`)},st=(e={},t=!0)=>n=>{t&&et(e),n.env.isDebug&&$.info("Options:",e);const a=(o,r=[])=>!!e[o]&&r.every(l=>Ve(l,!!e[o])),s={chartjs:a("chartjs",["chart.js"]),echarts:a("echarts",["echarts"]),flowchart:a("flowchart",["flowchart.ts"]),mark:a("mark"),markmap:a("markmap",["markmap-lib","markmap-toolbar","markmap-view"]),mermaid:a("mermaid",["mermaid"]),kotlinPlayground:a("kotlinPlayground",["kotlin-playground"]),sandpack:a("sandpack",["sandpack-vue3"]),vuePlayground:a("vuePlayground",["@vue/repl"])};return Se(n,{id:"hope"}),{name:X,define:()=>({CODE_DEMO_OPTIONS:{...F,...C(e.demo)?e.demo:{}},VUE_PLAYGROUND_MONACO:C(e.vuePlayground)&&e.vuePlayground.editor==="monaco"}),extendsBundlerOptions:(o,r)=>{we(o,r,["@vuepress/helper","fflate","vuepress-shared"]),s.chartjs&&(O(o,r,"chart.js/auto/auto.mjs"),P(o,r,"chart.js")),s.echarts&&(O(o,r,"echarts"),P(o,r,"echarts")),s.flowchart&&(O(o,r,"flowchart.ts"),P(o,r,"flowchart.ts")),s.markmap&&(D(o,r,["markmap-lib","markmap-toolbar","markmap-view"]),P(o,r,["markmap-lib","markmap-toolbar","markmap-view"])),s.mermaid&&(O(o,r,"mermaid/dist/mermaid.esm.min.mjs"),P(o,r,"mermaid")),s.kotlinPlayground&&(D(o,r,"kotlin-playground"),Ce(o,r,"kotlin-playground"),P(o,r,"kotlin-playground")),s.sandpack&&(D(o,r,"sandpack-vue3"),P(o,r,"sandpack-vue3")),s.vuePlayground&&(D(o,r,"@vue/repl"),P(o,r,"@vue/repl"),je(o,r,l=>{l.resolve.set("conditionNames",["browser","import","module"]),l.module.set("exprContextCritical",!1),l.module.set("unknownContextCritical",!1)}))},extendsMarkdown:o=>{if(s.flowchart&&(o.use(W),t&&o.use(nt)),s.chartjs&&(o.use(z),t&&o.use(Ze)),s.echarts&&o.use(B),Pe(e.plantuml)?o.use(N,e.plantuml):e.plantuml&&o.use(N),e.demo&&(o.use(G),o.use(J),o.use(L),o.use(V),t&&o.use(tt)),s.markmap&&o.use(le),s.mermaid&&o.use(ce),C(e.playground)){const{presets:r=[],config:l={}}=e.playground;r.forEach(i=>{i==="ts"?o.use(j,ee(l.ts??{})):i==="vue"?o.use(j,oe(l.vue??{})):i==="unocss"?o.use(j,ae(l.unocss??{})):C(i)&&o.use(j,i)})}s.kotlinPlayground&&o.use(re),s.vuePlayground&&o.use(de),s.sandpack&&o.use(ye)},clientConfigFile:o=>ot(o,e,s)}};export{F as CODE_DEMO_DEFAULT_SETTING,z as chartjs,B as echarts,W as flowchart,se as generateUnoURL,pe as getMermaidContent,ee as getTSPlaygroundPreset,Z as getURL,ae as getUnoPlaygroundPreset,oe as getVuePlaygroundPreset,re as kotlinPlayground,le as markmap,G as mdDemo,st as mdEnhancePlugin,ce as mermaid,J as normalDemo,N as plantuml,j as playground,V as reactDemo,ye as sandpack,L as vueDemo,de as vuePlayground};
