...
export interface ThemeOptions extends AppearanceOptions, FeatureOptions, InfoOptions, LayoutOptions, DefaultThemeData<ThemeLocaleOptions> {
    /**
...
export interface ThemeData extends AppearanceConfig, FeatureConfig, InfoOptions {
