...
`)},_=(t={})=>{const e=t.type??F(t);return{name:g,extendsBundlerOptions:(n,o)=>{k(n,o,"@vuepress/helper"),e==="iconify"&&A(n,o,"iconify-icon")},extendsMarkdown:n=>{t.markdown!==!1&&n.use($,{render:o=>{const{attrs:s,content:r,color:c,size:i}=w({content:o});return c&&!s.color&&(s.color=c),i&&!s.size&&(s.size=i),`<${t.component??"VPIcon"} icon="${r}"${h(s)} />`}})},clientConfigFile:n=>O(n,t,e)}};export{_ as iconPlugin};
